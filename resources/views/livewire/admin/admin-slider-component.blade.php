...
<a href="#" onclick="confirm('Are you sure,you wan to delete this slide?') || event.stopImmediatePropagation()" wire:click.prevent="deleteSlide({{$slide->id}})" style = "margin-left:10px;">
